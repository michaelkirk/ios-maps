...
struct ValhallahaTripLeg: Decodable {
  var maneuvers: [ValhallaManeuver]
}

struct ValhallaTrip: Decodable {
  var legs: [ValhallahaTripLeg]
}

struct ValhallaAlternate: Decodable {
  var trip: ValhallaTrip
}

struct ValhallaPlan: Decodable {
  //  var alternates: [ValhallaAlternate]?
  var trip: ValhallaTrip
}
